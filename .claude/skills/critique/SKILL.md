...
- **Command**: Which command to use (prefer: /colorize, /critique, /clarify, /distill, /optimize, /audit, /adapt, /extract, /polish, /delight, /onboard, /quieter, /normalize, /animate, /bolder, /harden — or other installed skills you're sure exist)
