...
- **Suggested command**: Which command to use (prefer: /colorize, /critique, /clarify, /distill, /optimize, /audit, /adapt, /extract, /polish, /delight, /onboard, /quieter, /normalize, /animate, /bolder, /harden — or other installed skills you're sure exist)
...
Map issues to available commands. Prefer these: /colorize, /critique, /clarify, /distill, /optimize, /audit, /adapt, /extract, /polish, /delight, /onboard, /quieter, /normalize, /animate, /bolder, /harden. You may also suggest other installed skills you're sure exist, but never invent commands.
